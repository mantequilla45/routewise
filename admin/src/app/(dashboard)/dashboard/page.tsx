        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {statCards.map((stat, index) => (
                    <div key={index} className="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-shadow duration-200 overflow-hidden">
                        <div className="p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-2xl shadow-sm p-6">
                    <div className="flex items-center justify-between mb-6">
                        <h2 className="text-lg font-semibold text-gray-900">Route Activity</h2>
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            <div key={item.day} className="flex items-center space-x-4">
                                <span className="text-sm text-gray-500 w-20">Day {item.day}</span>
                ...
                {/* Recent Activity */}
                <div className="bg-white rounded-2xl shadow-sm p-6">
                    <h2 className="text-lg font-semibold text-gray-900 mb-6">Recent Routes</h2>
                    <div className="space-y-4">
                        {recentRoutes.length > 0 ? (
                            recentRoutes.map((route, index) => (
                                <div key={route.id || index} className="flex items-start space-x-3">
                                    <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
                                    <div className="flex-1">
                                        <p className="text-sm text-gray-900">
                                            Route <span className="font-semibold">{route.route_code}</span>
                                        </p>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <a href="/routes" className="bg-white p-4 rounded-xl hover:shadow-md transition-shadow duration-200 text-center block">
                    ...
                    <a href="/analytics" className="bg-white p-4 rounded-xl hover:shadow-md transition-shadow duration-200 text-center block">
                    ...
                    <a href="/settings" className="bg-white p-4 rounded-xl hover:shadow-md transition-shadow duration-200 text-center block">
