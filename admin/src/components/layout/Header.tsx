            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex-1 max-w-xl">
                    <div className="relative">
                        ...
                        />
                        <kbd className="absolute right-3 top-1/2 transform -translate-y-1/2 text-xs text-gray-400 bg-white border border-gray-200 px-2 py-1 rounded font-mono">
                            ⌘K
                        </kbd>
                    </div>
                </div>
                                    ...
                                    <div className="p-4 hover:bg-blue-50 cursor-pointer border-b border-gray-50 transition-colors">
                                        <div className="flex items-start space-x-3">
                                            ...
                                            <div className="flex-1">
                                                <p className="text-sm text-gray-900">New route added: <span className="font-semibold">Route 42</span></p>
